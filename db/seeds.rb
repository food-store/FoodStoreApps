...
restaurant1 =Resto.create( name: "Arirang Madagascar",
	adress:"Rue Ramanantsoa A 50 m à droite du Manson",
...
puts "Arirang"
	...
	restaurant2 =Resto.create( name:"Le Carnivore",
		adress: " 66 Rue Ratsimilaho Ambatonakanga",
...
puts "Carnivore"
		...
		restaurant3 =Resto.create( name:"Carlton Madagascar",
			adress: "Rue Pierre-Stibbe Anosy Tana",
